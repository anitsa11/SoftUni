...
function log(target, key, descriptor) {
    ...
    descriptor.value = function () {
        try {
            ...
            console.log(`Method ${key} throw new error`);
        }
    };
    return descriptor;
}
function censorData(censorService) {
...
function latestOnly(seconds) {
    return function (target, key, descriptor) {
        ...
        descriptor.value = function () {
            ...
            const filteredResult = result.filter((el) => el.createdOn > oldTimestamp);
